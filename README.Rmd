...
![alt text](https://github.com/etam4260/dolr/blob/main/man/figures/DOL.png?raw=true)

This package contains an interface to
the US Department of Labor API in R. The goal
...
under it. For example, the most popular, the Bureau of Labor Statistics (BLS). Although
there already exists an R package for the BLS, this extends the reach and provides data
not under the oversight of the BLS.
...
DISCLAIMER: CURRENTLY ONLY THE HEALTH AND SAFETY DATASETS ARE WORKING AND MAY BE BUGGY.
